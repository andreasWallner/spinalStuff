...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set io_port0_0 [ create_bd_port -dir IO -from 4 -to 0 io_port0_0 ]
  set io_port1_0 [ create_bd_port -dir IO -from 4 -to 0 io_port1_0 ]
  set io_pwm_0_0 [ create_bd_port -dir O io_pwm_0_0 ]
  set io_pwm_1_0 [ create_bd_port -dir O io_pwm_1_0 ]
  set io_pwm_2_0 [ create_bd_port -dir O io_pwm_2_0 ]

  # Create instance: ApbSpinalTap_0, and set properties
  set block_name ApbSpinalTap
  set block_cell_name ApbSpinalTap_0
  if { [catch {set ApbSpinalTap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ApbSpinalTap_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {99} \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {99} \
   ...
   CONFIG.PCW_CAN_PERIPHERAL_DIVISOR0 {16} \
   CONFIG.PCW_CAN_PERIPHERAL_DIVISOR1 {1} \
   CONFIG.PCW_CAN_PERIPHERAL_FREQMHZ {100} \
   CONFIG.PCW_CAN_PERIPHERAL_VALID {1} \
   CONFIG.PCW_CLK0_FREQ {99000000} \
  ...
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins ApbSpinalTap_0/APB_S0] [get_bd_intf_pins axi_apb_bridge_0/APB_M]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M00_AXI] [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins ila_0/SLOT_0_AXI]

  # Create port connections
  connect_bd_net -net ApbSpinalTap_0_io_pwm_0 [get_bd_ports io_pwm_0_0] [get_bd_pins ApbSpinalTap_0/io_pwm_0]
  connect_bd_net -net ApbSpinalTap_0_io_pwm_1 [get_bd_ports io_pwm_1_0] [get_bd_pins ApbSpinalTap_0/io_pwm_1]
  connect_bd_net -net ApbSpinalTap_0_io_pwm_2 [get_bd_ports io_pwm_2_0] [get_bd_pins ApbSpinalTap_0/io_pwm_2]
  connect_bd_net -net Net [get_bd_ports io_port0_0] [get_bd_pins ApbSpinalTap_0/io_port0]
  connect_bd_net -net Net1 [get_bd_ports io_port1_0] [get_bd_pins ApbSpinalTap_0/io_port1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ApbSpinalTap_0/ACLK100M] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_99M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_99M_peripheral_aresetn [get_bd_pins ApbSpinalTap_0/ARESETN] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_99M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00100000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ApbSpinalTap_0/APB_S0/Reg] -force
